Before running the program 3 of the jar file (fontawesomefx-8.1.jar , mysql-connector-j-9.2.0.jar , ojdbc8.jar) that are available in the repository must be uploaded in the IDE
